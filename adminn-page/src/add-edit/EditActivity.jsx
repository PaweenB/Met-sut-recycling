    ...
    const fetchActivity = async () => {
      try {
        ...
        if (activityDocSnapshot.exists()) {
          ...
          setActivityDate(new Date(activityData.date));
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      const activityData = {
        ...
        imageURL: imageURL,
        description: activityDescription, // เพิ่มคำอธิบายกิจกรรม
      };
  ...
  return (
    <div className='actContainer'>
      ...
      <div className='missionContent'>
        <h2 className="mainHead">แก้ไขข้อมูลกิจกรรม</h2>
        ...
        <Row>
          ...
          <Col lg={16}>
            <form className="activityForm" onSubmit={handleFormSubmit}>
              ...
              <div className="formGroup">
                <label htmlFor="activityDescription">คำอธิบายกิจกรรม:</label>
                <textarea
              ...
              <div className="buttonGroup">
                ...
                <button type="submit" className="cancleButton">ยกเลิก</button>
              </div>
            </form>
          </Col>
        </Row>
